...
export const packs=[
  ...
  {name:"[BG] Frieren",creator:"DANZGAME",description:"Background pack bertema anime Frieren: Beyond Journey's End. Tampilan elegan dengan nuansa fantasy yang menenangkan.",icon:"../gudang/icon_pack/frieren.png",version:"1.0.0",category:"background",size:"8.2 MB",lastUpdated:"2025-06-20",download_pc:"downloads/troll_pc.zip",download_mobile:"downloads/troll_mobile.zip",featured:false,isNew:true},
